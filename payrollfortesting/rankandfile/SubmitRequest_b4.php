...
//include('Auth.php');
	...
	function PIFEmail($cIDno, $EmpNamex, $cControlNox)
		{
			//add $to sa parameters need to be passed para masend sa nlevel 0 or 1
			...
			$message .= '<a href="#"></a><a href="http://192.168.1.236/eUniform/response.php?w=' . $Level . '&x=' . $Approve . '&y=' . $_GET['ctrl'] . '" target="_blank" style="background-color: #999999;color: white; border: 1px solid #000000">APPROVE</a>  
						 <a href="http://192.168.1.236/eUniform/response.php?w=' . $Level . '&x=' . $Reject . '&y=' . $_GET['ctrl'] . '" target="_blank" style="background-color: #999999;color: white; border: 1px solid #000000">REJECT</a><br>';
		...
		if ($maxi>0)
				{
						...
						PIFEmail($cIDNumber, $vName, $cControlNo);
