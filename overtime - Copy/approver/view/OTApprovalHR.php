  ...
  <img src="../../../dist/img/user2-160x160.png" class="img-circle" alt="User Image">
   ...
   <a href="#"><?php echo $_SESSION['SESS_vDepartment'];?></a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li title="Overtime Form"><a href="OTApprovalHO_HR.php"><i class="fa fa-file-text-o"></i>Staff(s) OT For Approval</a></li>
        <li title="Overtime Form"><a href="OTApprovalHR.php"><i class="fa fa-file-text-o"></i>Employee(s) OT For Approval</a></li>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <?php
                  ...
                  from (select distinct(dDate), vdeptstore  from tOTProcess where cStatus = 'Approved') as r1";
                  ...
                  while ($rowAz = sqlsrv_fetch_array($rslt))  
                    ...
                    echo '<tr>
                          ...
                          echo '<td>
                                <form method="GET" action="../model/ViewOTDetails.php">
                                <input type="hidden" value="' . $dDate  . '" name="OTDatex">
                          ...
                          echo '<td>
                                <form method="GET" action="../model/HRApproveAll.php">
                                <input type="hidden" value="APPROVED" name="OTActionA">
                                <input type="hidden" value="' . $dDate  . '" name="OTDateA">
          ...
          <div class="box-body">
            <table id="example2" class="table table-bordered table-striped">
              ...
              <?php
                  ...
                  $functionqry = "SELECT * from tOTProcess where dDAte='". $dDatex ."' and vDeptStore='". $dDept ."' and cStatus = 'APPROVED'";
                  $rslt = sqlsrv_query($conn, $functionqry);
                  while ($rowAz = sqlsrv_fetch_array($rslt))  
                    {
