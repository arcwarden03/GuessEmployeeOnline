  ...
  <img src="../../../dist/img/user2-160x160.png" class="img-circle" alt="User Image">
   ...
   <a href="#"><?php echo $_SESSION['SESS_vDepartment'];?></a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li title="Overtime Form"><a href="OTApprovalHO_SOM.php"><i class="fa fa-file-text-o"></i>Employee(s) OT For Approval</a></li>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <?php
                  ...
                  /*$functionqry = "SELECT row_number() over (order by dDate asc) as 'RN', r1.dDate, r1.vDeptStore
                  from (select distinct(dDate), vdeptstore  from tOTProcess where cSysID in 
                  (select csysid from tApprover where vAppName = '" . $vAppNamex . "' and cStatus = 'PENDING' )) as r1";*/
                  
                  $functionqry = "SELECT distinct(vdeptstore) as 'vdeptstore' from tOTProcess where cSysID in 
                  ...
                  while ($rowAz = sqlsrv_fetch_array($rslt))  
                    ...
                    echo '<tr>
                          ...
                          echo '<td>
                                <form method="GET" action="../model/ViewOTDetailsSOM.php">
                          ...
                          echo '<td><center>
                                <form method="GET" action="../model/SOMApproveAll.php">
                                <input type="hidden" value="APPROVED" name="OTActionA">
              
                                <input type="hidden" value="' . $vDepartment  . '" name="OTDeptA">

                                <button type="submit" class="btn btn-success btn-xs">
                                <i class="fa fa-check-square-o"></i> &nbspApprove All</button>
                                </form></center></td>';
            ...
            <table id="example2" class="table table-bordered table-striped">
              ...
              <?php
                 ...
                 // $dDatex = $_SESSION['OT_Date'];
                  ...
                  if (isset($_SESSION['OT_Dept']))
                  {
                    //$functionqry = "SELECT * from tOTProcess where dDAte='". $dDatex ."' and vDeptStore='". $dDept ."' and cStatus = 'PENDING'";
                  
                    $functionqry = "SELECT * from tOTProcess where vDeptStore='". $dDept ."' and cStatus = 'PENDING'";
                  $rslt = sqlsrv_query($conn, $functionqry);
                  while ($rowAz = sqlsrv_fetch_array($rslt))  
                    {
