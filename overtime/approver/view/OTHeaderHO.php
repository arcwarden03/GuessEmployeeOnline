            ...
            if($Jobclass!='Rank and File' && $Area=='HO'){
              ...
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                   <center><a href="OTApprovalHO.php"> View All </a> </center>
                  </li>
                </ul>
              </li>
              <!-- </input> -->
                      ...
                      if (trim($_SESSION['SESS_cU_AccountType'])=='User' )
                        { 
                            ...
                            if (trim($_SESSION['SESS_cBranch'])=='Head Office')
                            {
                                ...
                                echo '<li title="Overtime Form"><a href="OTPendArcHO.php"><i class="fa fa-file-zip-o"></i>Pending & Archive OT</a></li>';
                                ...
                                echo'<li><a href="../../documents/EMS_USER_Manual_OT_HO_2.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li></li></ul>';
                                    ...
                                    if(trim($_SESSION['SESS_vDesignation']) == 'Store Manager'){
                                      ...
                                      echo '<li title="Overtime Form"><a href="OvertimeST.php"><i class="fa fa-file-text-o"></i>Overtime Application</a></li>';
                           ...
                           if (trim($_SESSION['SESS_cU_AccountType'])=='Approver')
                        {
                                ...
                                if (trim($_SESSION['SESS_vDepartment'])=='HHR: HRD' && trim($_SESSION['SESS_vDesignation'])=='HRD Assistant Manager'){
                                  ...
                                  echo '<li title="Overtime Approval"><a href="OTApprovalHO_HR.php"><i class="fa fa-check-square-o"></i>Staff OT for Approval</a></li>';
                                  echo '<li title="Overtime Approval"><a href="OTApprovalHR.php"><i class="fa fa-check-square-o"></i>OT Application for Approval</a></li></ul>';
                                
                                } elseif (trim($_SESSION['SESS_vDepartment'])=='HAS: Sales Operation'){

                                  if(trim($_SESSION['SESS_vDesignation']) != 'Sales Operation Manager') {
                                    echo '<li title="Overtime Approval"><a href="OTApprovalST.php"><i class="fa fa-check-square-o"></i>OT Application for Approval</a></li></ul>';
                                  }else{
                                    echo '<li title="Overtime Approval"><a href="OTApprovalHO_SOM.php"><i class="fa fa-check-square-o"></i>OT Application for Approval</a></li></ul>';
                                  }

                                } else {
                                  echo '<li title="Overtime Approval"><a href="OTApprovalHO.php"><i class="fa fa-check-square-o"></i>OT Application for Approval</a></li></ul>';
                                }
