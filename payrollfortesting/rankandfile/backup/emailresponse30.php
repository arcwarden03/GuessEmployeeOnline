    ...
    $lvlmax = $_GET['xLvlMax'];
            ...
            function PIFEmail($nlvl,$nMax, $eMail, $cControlNox)
                ...
                $to = 'mabrodriguez@guess.com.ph;';
                    ...
                    $message .= '<a href="http://192.168.1.236/guessemployeeonline/payrollfortesting/rankandfile/emailresponse.php?x=APPROVED&cSysIdx='
                     . trim($cControlNox) . '&xLvl=' . trim($nlvl) . ' &xLvlMax=' . trim($nMax) . '" target="_blank" style="background-color: #999999;color: white; border: 1px solid #000000">APPROVE</a> 
