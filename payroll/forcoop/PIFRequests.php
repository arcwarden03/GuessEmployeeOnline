    ...
    <div class="box-header"><h3 class="box-title">Pending PIF Requests</h3></div>
          <div class="box-body">
            <table id="" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                  $functionqry = "Select * from cooptblpayroll where cIDNumber = '" . $_SESSION['SESS_cIDNumber'] . "' order by dRequestDate desc";
...
<!--ARCHIVE BOX -->
          ...
          <table id="" class="table table-bordered table-striped">
            <thead>
              ...
              <tbody>
                <?php
                  $functionqry = "Select * from cooptblpayrollh where cIDNumber = '" . $_SESSION['SESS_cIDNumber'] . "'";
                  $result = mysql_query($functionqry ) or die(mysql_error());
                  $maxi=mysql_num_rows($result);
                  while ($row = mysql_fetch_array($result))     
                  {
