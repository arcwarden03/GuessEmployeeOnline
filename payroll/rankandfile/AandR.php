                 ...
                 if($dReason=='Unpaid Leave (VL / SL / EL)')
                        {
		                        	 ...
		                        	 //BYPASS	
		                      $qBypass = "update tblapprovers set cStatus = 'BYPASSED' where cControlNumber = '" . $cSysIdz . "' and nLevel < " . $lvl ." and cStatus = 'PENDING'";
							  ECHO $qBypass;
                            ...
                            $qryAdd = "update tblapprovers set cStatus = 'APPROVED', dApproveDate = '" . $dApproveDateTime . "'
                        ...
                        $subject = "Payroll Inquiry Form: Control Number: " . $cSysIDz. "";
                    ...
                    $eMail="";
                    $lvlx=$lvl +1 ;
                    $fApprover = "Select * from tblapprovers where cControlNumber = '" . $cSysIdz . "' and nLevel = '" . $lvlx . "'";
                    $rApprover = mysql_query($fApprover) or die(mysql_error());
                    $exists=mysql_num_rows($rApprover);
                    ...
                    //BYPASS	
                      ...
                      //update approval status
                        ...
                        $lvl = $lvl + 1;
                        PIFEmail($lvl,$lvlmax,$eMailx,$cSysIdz); 
