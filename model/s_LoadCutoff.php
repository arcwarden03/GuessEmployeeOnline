...
if (trim($_SESSION['SESS_cPassword'])=='it@guess')
{
	echo 'Unable to use function as you are still using default password!!!';
	exit();
}

$CutOff=$_REQUEST['CutOff'];
$qLoadQ = "SELECT * from vtransactionmirdetailedh where idno = '" . $_SESSION['SESS_cIDNumber'] . "' and cutoff = '" . $CutOff . "' and amount > 0";
