        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">DIRECT</a></li>
              <li><a href="#timeline" data-toggle="tab">AJW</a></li>
              <li><a href="#restel" data-toggle="tab">RESTEL </a></li>
...
<!---Direct Employee  -->
    ...
    <div class="box-header"><h3 class="box-title">Direct Employees-Pending for Approval</h3></div>
<br>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                  $functionqry = "Select * from tblpayroll where cControlNumber in (select cControlNumber from tblapprovers where cApprover1Status = 'APPROVED' and cCurrentLocation = 'Payroll for Processing') and vAgency='Direct' order by dRequestDate desc";
...
<!---Direct Employee  -->
 ...
 <div class="tab-pane" id="timeline">
    ...
    <div class="box-header"><h3 class="box-title">AJW Employees-Pending for Approval</h3></div>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                  $functionqry = "Select * from tblpayroll where cControlNumber in (select cControlNumber from tblapprovers where cApprover1Status = 'APPROVED' and cCurrentLocation = 'Payroll for Processing') and vAgency='All Job Works' order by dRequestDate desc";
                  $result = mysql_query($functionqry ) or die(mysql_error());
                  $maxi=mysql_num_rows($result);
                  while ($row = mysql_fetch_array($result))     
                  {
    ...
    <div class="box-header"><h3 class="box-title">Kings Cooperative Employees-Pending for Approval</h3></div>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                  $functionqry = "Select * from tblpayroll where cControlNumber in (select cControlNumber from tblapprovers where cApprover1Status = 'APPROVED' and cCurrentLocation = 'Payroll for Processing') and vAgency='KINGS COOPERATIVE' order by dRequestDate desc";
                  $result = mysql_query($functionqry ) or die(mysql_error());
                  $maxi=mysql_num_rows($result);
                  while ($row = mysql_fetch_array($result))     
                  {
                ...
                <div class="modal-dialog"  style="width:1000px">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <strong>Department: </strong> ' . $vDepartment  . '<br>
                      <strong>Designation: </strong> ' . $vDesignation  . '<br>
                      <strong>Agency: </strong> ' . $vAgency  . '<br>
                      ';
