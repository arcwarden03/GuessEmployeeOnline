   ...
   <a href="#"><?php echo $_SESSION['SESS_vDepartment'];?></a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Optionally, you can add icons to the links -->
          <li title="Payroll Inquiry Form"><a href="PIFReqHRD.php"><i class="fa fa-copy"></i>PIF COOP REQUESTS</a></li>
...
<body class="hold-transition skin-blue sidebar-mini fixed" " >
 ...
 <section class="content" id="sectionID">
  ...
  <div class="box box-primary col-md-12">
        ...
        <div class="box-header"><h3 class="box-title"><i class="fa fa-file-text-o"></i> ALL PIF COOP REQUESTS</h3>
        <br>
        <font color="grey"> 
        Note: <br>
        If Current Status is 'Approver' it means request is still pending for approval. <br>
        If Current Status is 'HRD For Validation' it means request is already sent to Agency for Processing.<br>
         </font>
...
<?php
                 ...
                 $functionqry = "Select * from cooptblpayroll order by dRequestDate desc";
                ...
                <div class="modal-dialog"  style="width:1000px">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <strong>Company: </strong> ' . $vAgency . '<br><br>

                      ';


                     include ('ViewDetailsHR.php');
