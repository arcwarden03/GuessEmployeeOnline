...
echo  '<td>
				 ...
				 <div class="col-sm-9">
                    <select class="form-control select" name="dRemarks" value ="'.$row['dPayrollRemarks'].'" / > 
 ...
 echo' <td>
		          <div class="col-sm-14">
                   <select class="form-control select" name="dAction" value ="'.$row['dPayrollAction'].'" / >
                   	<option name="1" value="">Select Remarks</option>	
...
//payroll response
         ...
         echo  ' <td><input type="text" name="dAdd" value ="'.$row['dAddResponse'].'" / > </td>';    
