  ...
  <img src="../../dist/img/user2-160x160.png" class="img-circle" alt="User Image">
   ...
   <a href="#"><?php echo $_SESSION['SESS_vDepartment'];?></a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <ul class="treeview-menu">
          <li title="Payroll Inquiry Form"><a href="PIFApprover.php"><i class="fa fa-check-square-o"></i>Payroll Inquiry for Approval </a></li>
            ...
            while ($rowlvlx = mysql_fetch_array($rlvlx))
              {
                $dReason = $rowlvlx['dReason'];
                 ...
                 //lvl max
              $query = "SELECT max(nLevel) as 'nMax' from tblapprovers where cControlNumber = '" .  $cControlNumber . "'"; 
