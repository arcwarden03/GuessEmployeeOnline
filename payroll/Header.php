            ...
            if($Jobclass!='Rank and File' && $Area=='HO'){
              ...
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                   <center><a href="PIFApprover.php"> View All </a> </center>
                  </li>
                </ul>
              </li>';
            }
                     ...
                     echo '<li title="Payroll History"><a href="../../views/PayrollHistory.php"><i class="fa fa-share-square-o"></i>Payroll History</a></li>';
                      ...
                      if (trim($_SESSION['SESS_cU_AccountType'])=='User' )
                           ...
                           if (trim($_SESSION['SESS_cU_AccountType'])=='Approver')
                        {
                                ...
                                echo '</a>';
                                echo '<ul class="treeview-menu">';
                                  echo '<li title="Payroll Inquiry Form"><a href="PIFApprover.php"><i class="fa fa-check-square-o"></i>Payroll Inquiry for Approval </a></li>';

                                  echo '<li title="Payroll Inquiry Form"><a href="../forcoop/PIFApprovers.php"><i class="fa fa-check-square-o"></i>PIF Approval for COOP</a></li>';
