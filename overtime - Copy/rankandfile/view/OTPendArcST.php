   ...
   <a href="#"><?php echo $_SESSION['SESS_vDepartment'];?></a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="../../../Mainpage.php"><i class="fa fa-home"></i> <span>Home</span></a></li>
          <li title="Overtime Form"><a href="OvertimeST.php"><i class="fa fa-file-text-o"></i>Overtime Application</a></li>
          <li title="Overtime Form"><a href="OTPendArcST.php"><i class="fa fa-file-zip-o"></i>Pending & Archive OT</a></li>
          <li title="Overtime Form"><a href="../../documents/EMS_USER_Manual_OT_ST_3.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li>
        ...
        <div class="box box-primary with-border">
          ...
          <div class="box-body">
              <table id="tblleaveApproverID" class="table table-bordered table-hover"> 
                ...
                <?php
                         $query = "SELECT * from tOTProcessH where cidnumber = '" . $cIDNumberx . "'";  
                         $rslt = sqlsrv_query($conn, $query);
                         while ($rowz = sqlsrv_fetch_array($rslt))  
                         {
