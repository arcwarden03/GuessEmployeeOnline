		...
		if ($maxi>0)
				{
						...
						$nLevel = 0;
							...
							while ($cnt<=5)
							{
								if(isset($_POST['App' . $cnt]))
								{
									...
									{
										$nLevel = $nLevel + 1;
										$qryAdd ="insert into tblappcoop (cControlNumber, vAppName, nLevel) ";
						...
						$qryAdd = $qryAdd . "select '" . $cControlNo . "', cIDNumber,dDate,dMonth,dYear,dCutoff,dReason temptablecoop where cidnumber = '" . $cIDNumber . "'";
						echo $qryAdd;
						$qryAddResult=mysql_query($qryAdd);
