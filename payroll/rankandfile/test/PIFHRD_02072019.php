      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="../../views/GlobalApprovals.php"><i class="fa fa-check-circle-o"></i> <span>Online Approval(s)</span></a></li>
          ...
          <ul class="treeview-menu">
           ...
           <li title="Payroll Inquiry Form"><a href="PIFHRD.php"><i class="fa fa-copy"></i>Pending Payroll Inquiries </a></li>
...
<br>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                  $functionqry = "Select * from tblpayroll where cControlNumber in (select cControlNumber from tblpayrolldetails where cApprover1Status = 'APPROVED' and cCurrentLocation = 'HRD for Processing') order by dRequestDate desc";
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     include ('ViewDetailsHRD.php');
                      ...
                      echo '<table>';
                        echo '<tr><td>';
                        echo '<form method="GET" action="ApproveNRejectHRD.php">';
                                                echo '<input type="hidden" value="' . $Approve  . '" name="x">';
                        echo '<input type="hidden" value="' . $x  . '" name="y">';
                      
                        echo '<button type="submit" class="btn btn-primary">Send to Payroll</button>  ';
                        echo '</form></td>';
                        echo '<td>';
