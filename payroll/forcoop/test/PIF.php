              ...
              <table class="table table-bordered table-hover"> 
                  ...
                  while($row = mysqli_fetch_assoc($result)){
                   ...
                   // ";
                    ...
                    echo"<td><a href='pif.php?id=$row[id]'><button class='btn btn-danger'>Remove</button></a></td>";
...
<?php 
  if(isset($_POST['submit'])){
    ...
    $insert_query = "INSERT INTO payrolltemptable (cIDNumber,cControlNumber,dDate,dMonth,dCutoff,dYear) VALUES ('$cIDnumber','$cControlNumber','$dDate','$dMonth','$dCutoff','$dYear')";
    
    if(mysqli_query($conn, $insert_query)) { ?>
      <script>window.location = 'pif.php'</script>
...
//
//$insert_query2 = "INSERT INTO tblpayroll (id,cControlNumber,cIDNumber) VALUES ('$id','$cControlNumber','$cIDNumber')";
   /// $insert_query2 = $insert_query2  . "select id,cControlNumber,cIDNumber from payrolltemptable where cIDNumber = '" . $cIDNumber . "'";
   // echo $insert_query2 ;
 ...
 // }
  ...
  if(isset($_POST['submit2'])) {
    ...
    //$query = "SELECT dDate From payrolltemptable WHERE cIDNumber = '" . $cIDNumber . "'";
           ...
           $insert_query2 = "INSERT INTO tblpayrolldetails (id,cIDNumber,dDate) VALUES ('$id',$cIDNumber','$dDate')";
  
           $insert_query2  ="INSERT INTO tblpayrolldetails (id,cIDNumber,dDate) ";
            $insert_query2 = $insert_query2  . "select id,cIDNumber,dDate from payrolltemptable where cIDNumber = '" . $cIDNumber . "'";
            echo $insert_query2 ;
            $qryinsert_query2=mysql_query($insert_query2);
