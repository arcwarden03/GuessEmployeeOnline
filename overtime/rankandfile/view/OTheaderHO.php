                ...
                <?php 
                     ...
                     echo '<li title="Payroll History"><a href="../../../views/PayrollHistory.php"><i class="fa fa-share-square-o"></i>Payroll History</a></li>';
                      ...
                      if (trim($_SESSION['SESS_cU_AccountType'])=='User' )
                                ...
                                echo'<li><a href="../../documents/EMS_USER_Manual_OT_HO_2.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li></li></ul>';
                                    ...
                                    if(trim($_SESSION['SESS_vDesignation']) == 'Store Manager'){
                                      ...
                                      echo'<li><a href="#" target=""><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li></li></ul>';
                                        ...
                                        echo'<li><a href="../../documents/EMS_USER_Manual_OT_ST_3.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li></li></ul>';
                        ...
                        echo'<li><a href="../../../documents/PIFRankandFile.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use PIF</a></li>';
                       ...
                       if (trim($_SESSION['SESS_cU_AccountType'])=='HRDpif')
                      {
                                ...
                                echo'<li><a href="../../documents/EMS_USER_Manual_OT_ST_3.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li></li>';
