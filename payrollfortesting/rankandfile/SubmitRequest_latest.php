	...
	function PIFEmail($nlvl, $eMail, $cIDno, $EmpNamex, $cControlNox)
		{
			...
			$message .= '<a href="http://192.168.1.236/guessemployeeonline/payrollfortesting/rankandfile/emailresponse.php?x=APPROVED&cSysIdx=' . trim($cControlNox) . '&nLvl=' . trim($xlvl) . '" target="_blank" style="background-color: #999999;color: white; border: 1px solid #000000">APPROVE</a> 
		...
		if ($maxi>0)
				{
						...
						PIFEmail(1, 'mabrodriguezguess.com.ph', $cIDNumber, $vName, $cControlNo);
