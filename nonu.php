    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <!-- Status -->
          <a href="#"><?php echo $_SESSION['SESS_isAllow_MR'];?></a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
                ...
                if(trim($_SESSION['SESS_vDesignation']) == 'Store Manager'){
                  ...
                  //allowed by ASM's below names
                    echo'<li><a href="overtime/documents/EMS_USER_Manual_OT_ST_3.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To Use OT Form</a></li></li></ul>';
                      ...
                      or trim($_SESSION['SESS_vName']) == 'FERRER, FRANCIS JANE BAJELOT'
                      or trim($_SESSION['SESS_vName']) == 'DE VERA, CHEENY AGAS'
		...
		<li  title="How To Use EMS"><a href="documents/EMS_Manual.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i><span>How To Use EMS</span></a></li>
...
<!-- Widget: user widget style 1 -->
  ...
  <footer class="main-footer">
    ...
    <!-- <strong>Copyright &copy; <a href="../estaffmngt/accounts/usr/views/esm_dashboard.php"> -->
         <strong>Copyright &copy; <a href="../eStaffMngt/esm_dashboard.php">Guess? IT Department 2018.</a></strong> All rights reserved. 
