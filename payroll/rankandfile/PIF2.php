       ...
       <center><li class="header"> <font color="white">MAIN NAVIGATION</font></li></center>
        ...
        <ul class="treeview-menu">
          ...
          <li title="Payroll Inquiry Form"><a href="PIFRequests.php"><i class="fa fa-file-zip-o"></i> Pending & Archive PIF </a></li>
           <li><a href="../../documents/PIFRankandFile.pdf" target="_blank"><i class="fa fa-sticky-note-o"></i>How To</a></li>
          </ul>
          </li>
    ...
    <!--NOTICE-->
     <div class="col-md-6" id="aView">
        <div class="box box-primary with-border">
          ...
          <div class="box-body">
            1.) Inquiry should be filed within (2)days upon receipt of payslip. <br>
            2.) Only Direct & AJW Employees can file the PIF.
        </div>
        </div>
    </div>
  <!--End Notice-->
